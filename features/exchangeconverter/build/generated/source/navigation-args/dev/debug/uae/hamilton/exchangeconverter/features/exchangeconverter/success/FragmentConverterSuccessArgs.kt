...
public data class FragmentConverterSuccessArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FragmentConverterSuccessArgs {
      bundle.setClassLoader(FragmentConverterSuccessArgs::class.java.classLoader)
      ...
      return FragmentConverterSuccessArgs(__conversionRequest)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        FragmentConverterSuccessArgs {
      val __conversionRequest : ConversionRequest?
